...
vaccines_rem2 <- vaccines_rem %>%
  ...
  select(c(County, Town, `Race/Ethnicity`, `Proportion of town population`, Population, `Fully vaccinated individuals`, `Proportion of town fully vaccinated individuals`))
